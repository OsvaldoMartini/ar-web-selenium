...
class ScannerBlockUpdatePublisherTest {
    ...
    void publishesBlockCreationUpdateToScannerAndPreScannerWorkspaces() {
        ...
        assertEquals(
                List.of(
                        publisher.performListDestinationSessionId(),
                        publisher.scannerGridDestinationSessionId(),
                        publisher.preScannerGridDestinationSessionId()),
                sender.messages.stream().map(Message::sessionId).toList());
        assertEquals(
                List.of(
                        ScannerWorkspaceOperations.UPDATE_BLOCKS,
                        publisher.blocksUpdateOperationId(),
                        publisher.blocksUpdateOperationId()),
