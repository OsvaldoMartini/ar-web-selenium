...
public class UCanAccessDialect extends SQLServerDialect {
    ...
    private static final UCanAccessDialectUniqueDelegate UNIQUE_DELEGATE = new UCanAccessDialectUniqueDelegate();

    public UniqueDelegate getUniqueDelegate() {
        return (UniqueDelegate) UNIQUE_DELEGATE;
    }

    private static final UCanAccessDialectLimitHandler LIMIT_HANDLER = new UCanAccessDialectLimitHandler();
