...
public class HomeBankingDTOFormB extends Application {
    ...
    private List<HomeBankingDTO> createSampleData() {
        ...
        for (int i = 0; i < 10; i++) {
            dataList.add(new HomeBankingDTO("Name " + i, "Priority " + i, "Username " + i, "Password " + i));
        }
        return dataList;
    }
    ...
    static class HomeBankingDTO {
        ...
        public HomeBankingDTO(String name, String priority, String username, String password) {
            this.name = name;
