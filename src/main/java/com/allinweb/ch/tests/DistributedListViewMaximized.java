...
public class DistributedListViewMaximized extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        HBox.setHgrow(listView1, javafx.scene.layout.Priority.ALWAYS);
        HBox.setHgrow(listView2, javafx.scene.layout.Priority.ALWAYS);
        HBox.setHgrow(listView3, javafx.scene.layout.Priority.ALWAYS);
