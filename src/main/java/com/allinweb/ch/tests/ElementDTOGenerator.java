...
public class ElementDTOGenerator {
    private static final String[] TAGS = {"div", "span", "input", "button", "a", "p", "h1", "h2", "h3", "ul", "li", "table", "tr", "td", "form", "label", "select", "option", "textarea", "img"};
    private static final String[] TYPES = {"text", "password", "checkbox", "radio", "submit", "reset", "hidden", "email", "number", "date"};
    private static final String[] COMMON_HTML_ATTRIBUTES = {
            "id", "class", "name", "href", "src", "alt", "title", "style",
            "placeholder", "value", "disabled", "checked", "readonly",
            "maxlength", "minlength", "required", "type", "role", "aria-label"
    };
    private static final String[] COMMON_TEXTS = {"Click Me", "Submit", "Username", "Email", "Search", "Password", "Welcome", "Home", "Profile", "Settings"};
    ...
    public static ObservableList<ElementDTO> getElementDTO() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            String someText = (tagName.equals("button") || tagName.equals("a") || tagName.equals("label") || tagName.startsWith("h")) ? COMMON_TEXTS[RANDOM.nextInt(COMMON_TEXTS.length)] : "";
            ...
            ElementDTO element = new ElementDTO(
                    typeElement, tagName, xPath, someText, attribId, attribName, coords,
                    attributeData, "//custom/xpath[" + i + "]", "//iframe/xpath[" + i + "]",
                    "attribute_value_" + i, "attribute_type_" + i, "search_value_" + i
            );
