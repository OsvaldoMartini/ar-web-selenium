...
public class ARConstants {
  ...
  public static final String REGULAR_XPATH =
      "REGULAR_XPATH"; // BECAUSE OS LIMITATION OF ACCESS DB 255 CHARACTER
  public static final String CUSTOM_XPATH =
      "CUSTOM_XPATH"; // BECAUSE OS LIMITATION OF ACCESS DB 255 CHARACTER
