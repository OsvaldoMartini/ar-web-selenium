        ...
        try (Connection conn = getConnection();
            ...
            while (rs.next()) {
                ...
                if (instruction == null) {
                    ...
                    instruction.setParentBlockId(PerformDataBase.readNullableInteger(rs, "parent_block_id"));
                    ...
                    instruction.setParentId(PerformDataBase.readNullableInteger(rs, "parent_id"));
                    instruction.setVariableId(PerformDataBase.readNullableInteger(rs, "variable_id"));
