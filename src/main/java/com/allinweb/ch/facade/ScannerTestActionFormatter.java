...
public final class ScannerTestActionFormatter {

    public String describeInputFlags(InputFlags flags) {
    ...
    public String safeTargetLabel(TargetElement target) {
    ...
    public boolean sameUrl(String first, String second) {
