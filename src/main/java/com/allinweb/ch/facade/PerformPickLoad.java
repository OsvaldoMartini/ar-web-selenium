...
public class PerformPickLoad {
    ...
    public ErrorMessage dynamicPickElementsDTO(
            WebDriver driver, String currentUrl, String[] dataArray, boolean searchHiddenFields, int port) {

        List<String> dataList = Arrays.asList(dataArray);
        try {
            jsExecutor = (JavascriptExecutor) driver;
            jsExecutor.executeScript(jsCodePickInject, currentUrl, currentUrl, dataList, searchHiddenFields, port);
            return null;
    ...
    private String jsCodePickInject =
            """
                    (function (
                      targetOriginURL,
                      trustedOriginURL,
