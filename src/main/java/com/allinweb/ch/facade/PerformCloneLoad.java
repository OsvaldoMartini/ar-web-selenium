...
public class PerformCloneLoad {
    ...
    public ErrorMessage dynamicCloneElementsDTO(
            WebDriver driver, String currentUrl, String[] dataArray, boolean searchHiddenFields, int port) {

        List<String> dataList = Arrays.asList(dataArray);
        try {
            jsExecutor = (JavascriptExecutor) driver;
            jsExecutor.executeScript(jsCodeCloneInject, currentUrl, currentUrl, dataList, searchHiddenFields, port);
            return null;
    ...
    private String jsCodeCloneInject =
            """
                    (function (
                      targetOriginURL,
                      trustedOriginURL,
