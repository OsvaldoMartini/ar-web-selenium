 ...
 * @version 1.0
 */
public class ExportAccessToPostgres {
    protected static volatile ExportAccessToPostgres instance;
    ...
    public static ExportAccessToPostgres getInstance() {
        if (instance == null) {
            synchronized (ExportAccessToPostgres.class) {
                if (instance == null) {
                    instance = new ExportAccessToPostgres();
                }
            }
        }
        return instance;
    ...
    public void exportHomeBanking() {
        ...
        ARLogger.getInstance(PerformDataBase.class).info("User Details: " + userDB + " - " + userPwd);
        ...
        try (Connection accessConn = DriverManager.getConnection(accessDbUrl);
                ...
                Statement idStmtBefore = postgresConn.createStatement();
                Statement idStmtAfter = postgresConn.createStatement()) {
