...
public class ExcelReader {
  ...
  public ExtractedData extractData(String paymentsFilePath, List<String> allActions)
      throws Exception {
    ...
    try (XSSFWorkbook workbook = new XSSFWorkbook(new File(paymentsFilePath))) {
      ...
      for (String action : allActions) {
        // Check if action contains ARConstants.INSERT and
      ...
      // Cache existing field values from extractedData and add them to
      // extractedDataWithMissingFields
