...
//                PerformDataBase..getEntityById(ComponentInstructionDTO.class, instruction.getId());
//        int order = currentInstruction.getInstructionOrderNumber();
//
//        ComponentBlockDTO block =
//                PerformDataBase..getEntityById(ComponentBlockDTO.class,
// currentInstruction.getBlockId());
...
//        PerformDataBase.
//                .updateEntity(currentInstruction, ComponentInstructionDTO.class, () -> PerformDataBase.
