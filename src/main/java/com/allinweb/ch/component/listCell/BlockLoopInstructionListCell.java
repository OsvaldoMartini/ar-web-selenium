...
//
// import lombok.extern.slf4j.Slf4j;  @Slf4j public class BlockLoopInstructionListCell extends ListCell<InstructionLoad>
// {
//    @Override
...
//        if (isValid) {
//            ARLogger.getInstance(BlockLoopInstructionListCell.class)log.info(item.getActions());
