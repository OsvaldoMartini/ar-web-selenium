...
//
//        ObservableList<BlockDTO> blockList = PerformDataBase.
//                .getEntityList(
//                        BlockDTO.class,
//                        Comparator.comparingInt(BlockDTO::getId),
//                        (block) ->
//                                this.block.getBotJobId() == block.getBotJobId() && this.block.getId() !=
// block.getId());
//
//        if (blockList.size() > 0) {
...
//
//                ObservableList<BlockDTO> blockObservableList = PerformDataBase.
//                        .getEntityList(
//                                BlockDTO.class,
...
//
//                PerformDataBase..updateAllEntity(queue, BlockDTO.class, () -> {
//                    block.setBlockOrderNumber(selectBlockOrderNumber);
//
//                    PerformDataBase..updateEntity(block, BlockDTO.class);
//                });
//
//                Close();
//            }
