...
//                e -> insertNewInstruction("NEXT ROW", "EXCEL NEXT ROW", ARConstants.NEXT_ROW, 0, "", null, null,
// null));
...
//                insertNewInstruction("Wait 30second(s)", "Waiting action", ARConstants.HOLD, 30, "", null, null,
// null));
//        addWaitButton15.setOnAction(e ->
//                insertNewInstruction("Wait 15second(s)", "Waiting action", ARConstants.HOLD, 15, "", null, null,
// null));
...
//                e -> insertNewInstruction("Close Browser", "Close Browser", ARConstants.QUIT, 0, "", null, null,
// null));
//
...
//
//                variableButtonRow =
//                        new HBox(10, blankText, timesText, comboBoxTimes, loopText, comboBoxLoops, gotoField,
// textFlow);
//
//                vboxAll.getChildren()
//                        .addAll(
