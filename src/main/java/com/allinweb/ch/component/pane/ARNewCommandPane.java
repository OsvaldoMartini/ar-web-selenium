...
public class ARNewCommandPane extends ARPane {
  ...
  public void initialize(RowMoveDTO rowMoveDTO) {
    ...
    this.filteredPageItems.addAll(
        webPageItems.stream()
            //                .filter(item -> !"button".equals(item.getTagType()) &&
            // !"a".equals(item.getTagType()))
            .map(
                item ->
                    new ComboBoxImage(
                        item.getText(),
    ...
    try {
      ...
      //                    new ComboBoxImage("Select", new Image(ARConstants.ICON_BLANK),
      // ARConstants.NO_VALUE));
      itemsInstructions.add(
          new ComboBoxImage(
              "SetValue",
              new Image(ARConstants.ICON_SET_VALUE_BTN),
      ...
      itemsInstructions.add(
          new ComboBoxImage(
              "GetValue",
              new Image(ARConstants.ICON_GET_VALUE_BTN),
      ...
      itemsInstructions.add(
          new ComboBoxImage(
              "CheckValue",
              new Image(ARConstants.ICON_CHECK),
      ...
      itemsInstructions.add(
          new ComboBoxImage(
              "GOTO", new Image(ARConstants.ICON_GOTO), ARConstants.GOTO, -1, -1, -1));

      itemsInstructions.add(
          new ComboBoxImage(
              "Excel GOTO",
              new Image(ARConstants.ICON_EXCEL_GOTO),
      ...
      itemsInstructions.add(
          new ComboBoxImage(
              "ExcelWrite",
              new Image(ARConstants.ICON_EXCEL),
      ...
      itemsInstructions.add(
          new ComboBoxImage(
              "Refresh",
              new Image(ARConstants.ICON_REFRESH_ONLY),
              ARConstants.REFRESH_ONLY,
              -1,
              -1,
              -1));
      itemsInstructions.add(
          new ComboBoxImage(
              "Loop", new Image(ARConstants.ICON_REFRESH_LOOP), ARConstants.LOOP, -1, -1, -1));
      itemsInstructions.add(
          new ComboBoxImage(
              "Refresh Loop",
              new Image(ARConstants.ICON_REFRESH_LOOP),
    ...
    if (itemsInstructions.isEmpty() || itemsInstructions.size() == 0) {
      itemsInstructions.add(
          new ComboBoxImage(
              "No Instructions",
              new Image(ARConstants.ICON_BLANK),
              ARConstants.NO_VALUE,
              -1,
              -1,
              -1));
    ...
    if (operatorsItems.size() == 0) {
      operatorsItems.add(
          new ComboBoxOperator(
              "No Operators", new Image(ARConstants.ICON_BLANK), ARConstants.NO_VALUE));
    }

    if (filteredPageItems.isEmpty()) {
      filteredPageItems.add(
          new ComboBoxImage(
              "No Web Fields",
              new Image(ARConstants.ICON_BLANK),
              ARConstants.NO_VALUE,
    ...
    if (rowMoveDTO.getSessionId().equals("componentTasks")) {
      this.blockLoadList =
          performDataBase.loadCompBlocksByHomeId(
  ...
  public void initUIComponents() {
    ...
    comboBoxInstruc.setCellFactory(
        param ->
            new ListCell<>() {
              @Override
              protected void updateItem(ComboBoxImage item, boolean empty) {
    ...
    // Set cell factory to display images and text
    comboBoxOperator.setButtonCell(
        new ListCell<>() {
          @Override
    ...
    comboBoxOperator.setCellFactory(
        param ->
            new ListCell<>() {
              @Override
              protected void updateItem(ComboBoxOperator item, boolean empty) {
    ...
    comboBoxBlocksGoto.setButtonCell(
        new ListCell<>() {
          @Override
    ...
    comboBoxBlocksGoto.setCellFactory(
        param ->
            new ListCell<>() {
              @Override
              protected void updateItem(BlockOptions item, boolean empty) {
    ...
    comboBoxWebFields.setButtonCell(
        new ListCell<>() {
          @Override
          protected void updateItem(ComboBoxImage item, boolean empty) {
            super.updateItem(item, empty);
    ...
    comboBoxWebFields.setCellFactory(
        param ->
            new ListCell<>() {
              @Override
              protected void updateItem(ComboBoxImage item, boolean empty) {
    ...
    comboBoxAllBlocks.setButtonCell(
        new ListCell<>() {
          @Override
          protected void updateItem(BlockOptions item, boolean empty) {
            super.updateItem(item, empty);
    ...
    comboBoxAllBlocks.setCellFactory(
        param ->
            new ListCell<>() {
              @Override
              protected void updateItem(BlockOptions item, boolean empty) {
  ...
  private void setCombosAndLabels() {
    if (rowMoveDTO.getType().equals("EDIT_OPERATION")) {
      ...
      String[] operations =
          rowMoveDTO.getUpdatedRows().get(0).getOperation() != null
              ? rowMoveDTO
                  .getUpdatedRows()
                  .get(0)
                  .getOperation()
  ...
  public void initUIBehaviour() {
    ...
    addPauseButton.setOnAction(
        e ->
            insertNewInstruction(
                "PAUSE", "PAUSE Action", ARConstants.PAUSE, 0, "", null, null, rowMoveDTO));
    addWaitButton30.setOnAction(
        e ->
            insertNewInstruction(
                "Wait 30second(s)",
                "Waiting action",
    ...
    this.addNewInstructionButton.setOnMouseClicked(
        (e) -> {
          ...
          if (!comboBoxInstruc.getValue().getValue().equalsIgnoreCase(ARConstants.IF)
            ...
            performMessage.errorMessage(
                ...
                "Please define a variable for: \"" + comboBoxWebFields.getValue().getText() + "\".",
                null,
                null,
                0);
            return;
          ...
          if (!comboBoxInstruc.getValue().getValue().equalsIgnoreCase(ARConstants.IF)
              ...
              && !comboBoxInstruc
                  .getValue()
                  .getValue()
                  .equalsIgnoreCase(ARConstants.REFRESH_ONLY)) {
            if (comboBoxAllBlocks.getValue() != null
              ...
              String outsideBlock =
                  allBlocksItems.stream()
                      .filter(f -> f.getBlockId().equals(comboBoxWebFields.getValue().getBlockId()))
          ...
          if (rowMoveDTO.getUpdatedRows().get(0).getInstructionOrderNumber()
            ...
            if (rowMoveDTO.getType().equals("INSERT_AFTER")) {
              rowMoveDTO
                  .getUpdatedRows()
                  .get(0)
                  .setInstructionOrderNumber(comboBoxWebFields.getValue().getOrderNumber());
            } else {
              rowMoveDTO
                  .getUpdatedRows()
                  .get(0)
                  .setInstructionOrderNumber(comboBoxWebFields.getValue().getOrderNumber() + 1);
            }
          }
          ...
          if (comboBoxInstruc.getValue().getText().equalsIgnoreCase("SetValue")) {
            ...
            insertNewInstruction(
                ...
                ARConstants.LOOP,
                2,
                comboBoxTimes.getValue().getValue() + ":" + comboBoxLoops.getValue().getValue(),
                null,
            ...
            insertNewInstruction(
                ...
                comboBoxBlocksGoto.getValue().getBlockId(), // BLOCK ID as Parent Id
                this.rowMoveDTO);
    ...
    comboBoxWebFields
        ...
        .addListener(
            new ChangeListener<ComboBoxImage>() {
              @Override
              public void changed(
    ...
    variableButton.setOnAction(
        e -> {
          if (this.rowMoveDTO != null && !rowMoveDTO.getUpdatedRows().isEmpty()) {
            ARLogger.getInstance(ARNewCommandPane.class)
                .info(
                    "creating variable for instruction Name "
    ...
    comboBoxInstruc
        ...
        .addListener(
            (observable, oldValue, newValue) -> {
              if (newValue != null) {
                if (!firstLoad) {
                  if (ARConstants.EXCEL_GOTO.equalsIgnoreCase(
                      String.valueOf(newValue.getValue()))) {
                    loadBlockItems(blockLoadList, -99);
                  } else {
                    loadBlockItems(blockLoadList, rowMoveDTO.getBlockId());
                  }
                  recallMessages(comboBoxInstruc.getValue().getValue());
                  if (comboBoxVars.getValue() != null && comboBoxVars.getValue().getVarId() > -1) {
                    arElementValueScene.setTableRowById(comboBoxVars.getValue().getVarId());
                  } else {
                    arElementValueScene.initialize(
                        rowMoveDTO,
                        comboBoxVars.getValue().getVarId(),
  ...
  public void reloadComboVars(int instructionId, boolean selectLast, int variableId) {
    ...
    if (variablesList != null && variablesList.size() > 0) {
      List<ComboBoxVars> variablesNames =
          variablesList.stream()
              .map(
                  variable ->
                      new ComboBoxVars(
      ...
      variablesItems.add(
          new ComboBoxVars("no variables added", "", -1, -1, -1, -1, null, -1, null));
      if (selectLast) {
        comboBoxVars.getSelectionModel().selectFirst();
      }
    }
  ...
  private void insertNewInstruction(
    ...
    if (actions.equals("EXCEL GOTO")) {
      ...
      List<InstructionLoadDTO> excelDataGoto =
          performDataBase.loadExcelGotoBlock(
      ...
      if (!excelDataGoto.isEmpty()) {
        ...
        rowMoveDTO.getUpdatedRows().get(0).setInstructionId(excelDataGoto.get(0).getId());
      } else {
    ...
    for (int added = endifCount; added >= 1; added--) {
      ...
      int newRowId =
          performDataBase.preFillInstruction(
  ...
  public void setSelectedIndexByValue(String instrValue, String[] operations) {
    Platform.runLater(
        () -> {
          ...
          Integer instrunctionId =
              rowMoveDTO.getUpdatedRows().get(0).getParentId() != null
                  ? rowMoveDTO.getUpdatedRows().get(0).getParentId()
                  : -1;

          Integer variableId =
              rowMoveDTO.getUpdatedRows().get(0).getVariableId() != null
          ...
          if (instrValue.equals("EXCEL GOTO")) {
            for (int i = 0; i < blocksGotoItems.size(); i++) {
              if (blocksGotoItems
                  .get(i)
                  .getBlockId()
                  .equals(rowMoveDTO.getUpdatedRows().get(0).getParentId())) {
                comboBoxBlocksGoto.getSelectionModel().select(i);
                indexGeneric = i;
                break;
              }
