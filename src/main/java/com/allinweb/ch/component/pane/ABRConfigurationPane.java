...
public class ABRConfigurationPane extends ABRPane {
    ...
    public void initUIComponents() {
        ...
        AnchorPane logGroup = new AnchorPane(pathLog, pathLogButton);
        ...
        saveButton = builder.buildButton("Save");
        saveButton.setMaxHeight(ABRConstants.SPACE_L);
        AnchorPane.setTopAnchor(
                saveButton,
                pathGroup.getChildren().size() * (ABRConstants.SPACE_M + ABRConstants.SPACE_XS) + ABRConstants.SPACE_L);
    ...
    private void saveConfigurations() {
        ABRPropertyManager.getInstance().setProperty(ABRPropertyEnum.FOLDER_PATH_EXCEL.getValue(), pathExcel.getText());
        ABRPropertyManager.getInstance().setProperty(ABRPropertyEnum.FOLDER_PATH_LOG.getValue(), pathLog.getText());
        ABRPropertyManager.getInstance().setProperty(ABRPropertyEnum.FOLDER_PATH_JAVA.getValue(), pathJava.getText());
        ...
        ABRPropertyManager.getInstance().setProperty(ABRPropertyEnum.BROWSER.getValue(), browserChoiceBox.getValue());
